...
END $$ DELIMITER ;
-- =============================================== ALL-TIME AVERAGES =============================================== --
DELIMITER $$ CREATE PROCEDURE player_career_avg(IN p_player_id INT) BEGIN
-- Declaring variables where the averages are going to be stored:
DECLARE total_games INT;
DECLARE avg_pts FLOAT;
DECLARE avg_ast FLOAT;
DECLARE avg_dreb FLOAT;
...
DELIMITER $$
CREATE PROCEDURE get_team_alltime_averages(IN p_team_id VARCHAR(10))
BEGIN
    DECLARE total_games INT;
    DECLARE avg_pts FLOAT;
    DECLARE avg_ast FLOAT;
